      ...
      <div>
        ...
        {/* <div style={{ backgroundColor: "orange" }}>
          <h2
            ...
            style={{ paddingTop: 40, paddingBottom: 40, paddingLeft: 60 }}
          >
            About
          </h2>
        </div>
                ...
                <div className="container text-center">
                    ...
                    <div className="row">
                        <div className="col-md-4 pl-0 pr-3">
                            <div className="team__item">
                                <div className="team__image">
                                    <img src={require("../../assets/img/team-member-5.jpg")} alt="team-member" />
                        ...
                        <div className="col-md-4 px-2">
                            <div className="team__item">
                                <div className="team__image">
                                    <img src={require("../../assets/img/team-member-3.jpg")} alt="team-member" style={{width: "100%", height: 290}} />
                                    <div className="team__social">
                                        <i className="fab fa-facebook-f" />
                                        <i className="fab fa-twitter" />
                                        <i className="fab fa-google-plus-g" />
                        ...
                        <div className="col-md-4 pr-0 pl-3">
                            <div className="team__item">
                                <div className="team__image">
                                    <img src={require("../../assets/img/team-member-6.jpg")} alt="team-member" />
                                    <div className="team__social">
                                        <i className="fab fa-facebook-f" />
                                        <i className="fab fa-twitter" />
                                        <i className="fab fa-google-plus-g" />
