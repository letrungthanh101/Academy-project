                  ...
                  <div className="container countdown__wrapper">
                      <div className="row ">
                          <div className="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                              <div className="countdown__event " style={{marginTop:250}}>
                                  ...
                                  <h2 className="countdown__title">IT CONFERENCE 2020</h2>
                                  <h3 className="countdown__subtitle">10 - 12 DECEMBER, 2020, HUTECH</h3>
                              </div>
                          </div>
                      </div>
                  </div>
                      ...
                      <div className="row">
                          <div className="col-sm-4 col-md-4 col-lg-4 col-xl-4 ticket__left">
                              <div className="ticket__image">
                                  <img src={require("../../assets/img/event-icon.png")} alt="ticket" />
                              </div>
                          </div>
                      ...
                      <div className="row speakers">
                          ...
                          <div className="col-sm-3 col-md-3 col-lg-3 col-xl-3 speaker">
                              <div className="">
                                  <div className="speaker__image">
                                      <img src=  {require("../../assets/img/event-speaker1.jpg")} alt="speaker" />
                                  </div>
                          ...
                          <div className="col-sm-3 col-md-3 col-lg-3 col-xl-3 speaker">
                              <div className="speaker">
                                  <div className="speaker__image">
                                      <img src={require("../../assets/img/event-speaker2.jpg")} alt="speaker" />
                                  </div>
                                  <div className="speaker__info">
                                      <h5>JAMIE WEN</h5>
                                      <p>GM, The boxtrap</p>
                          ...
                          <div className="col-sm-3 col-md-3 col-lg-3 col-xl-3 speaker">
                              <div className="speaker">
                                  <div className="speaker__image">
                                      <img src={require("../../assets/img/event-speaker3.jpg")} alt="speaker" />
                                  </div>
                                  <div className="speaker__info">
                                      <h5>CHELSIE</h5>
                                      <p>CEO, Hatem Co.</p>
                          ...
                          <div className="col-sm-3 col-md-3 col-lg-3 col-xl-3 speaker">
                              <div className="speaker">
                                  <div className="speaker__image">
                                      <img src={require("../../assets/img/event-speaker4.jpg")}alt="speaker" />
                                  </div>
                                  <div className="speaker__info">
                          ...
                          <div className="col-sm-3 col-md-3 col-lg-3 col-xl-3 speaker">
                              <div className="speaker">
                                  <div className="speaker__image">
                                      <img src={require("../../assets/img/event-speaker5.jpg")} alt="speaker" />
                                  </div>
                                  <div className="speaker__info">
                                      <h5>RUTH SMITH</h5>
                          ...
                          <div className="col-sm-3 col-md-3 col-lg-3 col-xl-3 speaker">
                              <div className="speaker">
                                  <div className="speaker__image">
                                      <img src={require("../../assets/img/event-speaker6.jpg")}alt="speaker" />
                                  </div>
                                  <div className="speaker__info">
                                      <h5>RICKEY D.NG</h5>
                          ...
                          <div className="col-sm-3 col-md-3 col-lg-3 col-xl-3 speaker">
                              <div className="speaker">
                                  <div className="speaker__image">
                                      <img src={require("../../assets/img/event-speaker7.jpg")}alt="speaker" />
                                  </div>
                                  <div className="speaker__info">
                                      <h5>ROBIN GUZMAN</h5>
                          ...
                          <div className="col-sm-3 col-md-3 col-lg-3 col-xl-3 speaker">
                              <div className="speaker">
                                  <div className="speaker__image">
                                      <img src={require("../../assets/img/event-speaker8.jpg")} alt="speaker" />
                                  </div>
                                  <div className="speaker__info">
                                      <h5>CODY BALL</h5>
                                      <p>Pixar Animation Studios</p>
